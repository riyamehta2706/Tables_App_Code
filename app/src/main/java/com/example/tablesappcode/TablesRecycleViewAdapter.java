package com.example.tablesappcode;
...
public class TablesRecycleViewAdapter extends RecyclerView.Adapter<TablesRecycleViewAdapter.ViewHolder>{

    List<String> mData;
    LayoutInflater mLayoutInflator;

    TablesRecycleViewAdapter(List<String>data, Context context){
        this.mData=data;
